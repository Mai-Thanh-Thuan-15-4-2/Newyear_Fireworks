/*
Mã nguồn này được chỉnh sửa dựa trên XgpNwb
...
const helpContent = {
	shellType: {
		...
		body: 'The type of firework you want to launch. Choosing "Random" can give you a very good experience!'
	},
	shellSize: {
		header: 'Firework Size',
		body: 'The larger the firework, the larger the bloom range. But the larger the firework, the more performance your device needs, and large fireworks may cause your device to stutter.'
	},
	quality: {
		header: 'Quality',
		body: 'If the animation is not smooth, you can try to lower the quality. The higher the quality, the more sparks there will be after the firework blooms, but high quality may cause your device to stutter.'
	},
	skyLighting: {
		header: 'Light Up the Sky',
		body: 'When the firework explodes, the background will be illuminated. If your screen looks too bright, you can change it to "Dark" or "No".'
	},
	scaleFactor: {
		header: 'Zoom',
		body: 'Makes you closer or farther from the fireworks. For larger fireworks, you can choose a smaller zoom value, especially on mobile phones or tablets.'
	},
	autoLaunch: {
		header: 'Auto Launch Fireworks',
		body: 'After turning it on, you can sit in front of your device screen and enjoy the fireworks. You can also turn it off, but after turning it off, you can only launch fireworks by clicking on the screen.'
	},
	finaleMode: {
		header: 'Launch More Fireworks at the Same Time',
		body: 'Can automatically launch more fireworks at the same time (but you need to turn on "Auto Launch Fireworks" first).'
	},
	hideControls: {
		header: 'Hide Control Buttons',
		body: 'Hide the buttons at the top of the screen. If you want to take a screenshot, or need a seamless experience, you can hide the buttons, and after hiding the buttons, you can still open the settings in the upper right corner.'
	},
	fullscreen: {
		header: 'Fullscreen',
	...
	longExposure: {
		header: 'Retain Firework Sparks',
		body: 'Can retain the sparks left by the fireworks'
	}
};
...
if (IS_HEADER) {
	...
	setLoadingStatus('Igniting the fuse');
	setTimeout(() => {
